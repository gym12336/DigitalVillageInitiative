...
export const modules = [
  {
    id: 'villages', name: '乡村百科', icon: 'villages', path: '/villages', enabled: true, desc: '一村一页，读懂中国乡村',
    hook: '从历史沿革到特色资源，为每个村庄建一张会生长的数字名片。',
    metric: `${platformDemoStats.archivedVillages} 个演示村庄档案`,
    children: [
  ...
  {
    id: 'practice', name: '乡村实践', icon: 'practice', path: '/practice', enabled: true, desc: '用脚步丈量，用实践记录',
    hook: '汇聚全国三下乡团队的实践成果，用数据、人物与影像记录乡村的改变。',
    metric: `${platformDemoStats.practiceResults} 份演示成果`,
    children: [
  ...
  {
    id: 'voice', name: '乡村之声', icon: 'voice', path: '/voice', enabled: true, desc: '乡村出题，青年回应',
    hook: '乡镇发布真实需求，高校团队精准响应；乡村提问，青年作答。',
    metric: `${platformDemoStats.publishedDemands} 条演示需求`,
  },
  {
    id: 'guide', name: '实践攻略', icon: 'guide', path: '/guide', enabled: true, desc: '从行前到成果，一本通关',
    hook: '行前准备、调研工具、报告模板、安全保障，一站式带你完成下乡。',
    metric: '全流程攻略',
  },
  {
    id: 'goods', name: '乡村好物', icon: 'goods', path: '/goods', enabled: true, desc: '每件好物背后都有一个村庄',
    hook: '农副产品、手工艺、非遗与文创，以消费帮扶助力乡村振兴。',
    metric: '8 件演示好物',
  },
  {
    id: 'about', name: '关于我们', icon: 'about', path: '/about', enabled: true, desc: '青年与乡村的桥梁',
