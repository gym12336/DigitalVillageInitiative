<template>
  ...
  <div class="node-inner">
    ...
    <div v-else class="card">
      ...
      <p v-if="node.view.missing" class="missing"><AppIcon name="archive" :size="14" />数据源为空，待补充</p>
      ...
      <template v-else>
        ...
        <div v-else-if="node.type === 'mapPoint'" class="map-point">
          <AppIcon class="map-pin" name="map-pin" :size="22" />
...
.missing { display: flex; align-items: center; gap: .4rem; margin: 0; font-size: .84rem; color: var(--color-text-light); }
